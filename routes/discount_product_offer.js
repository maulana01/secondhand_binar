...
router.put(`${disc_product_offer_path}/accept/:id`, IsAuth, IsProfileFilled, DiscProductOfferCtl.acceptDiscProduct);
router.put(`${disc_product_offer_path}/reject/:id`, IsAuth, IsProfileFilled, DiscProductOfferCtl.rejectDiscProduct);
